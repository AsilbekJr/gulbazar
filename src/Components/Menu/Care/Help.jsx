...
const Help = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Typography sx={{textAlign:"center", width:{xs:"100%", sm:"100%", md:"60%", ld:"50%"}}}>Biz sizga eng zarur va to'g'ri maslahatlar berishga tayyormiz. Biz bilan bo'g'laning, bizdan konsultatsiyalar oling va o'z o'simliklaringizga g'amxo'rlik qiling.</Typography>     
       </Box>
       <Box sx={{padding:"4rem 0", display:"flex", flexDirection:"column", alignItems:"center"}}>
        ...
        <Box sx={{width:{xs:"160px", sm:"250px", md:"350px", lg:"400px"}, maxWidth:"400px",textAlign:"center", padding:"40px 15px 50px 15px",display:"flex", flexDirection:"column",alignItems:"center", backgroundColor:"#fff"}}>
